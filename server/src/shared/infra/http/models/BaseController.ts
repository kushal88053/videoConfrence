...
export interface VideoAppRequest<B = {}, P = {}> {
    body: B;
    pathParams: P;
    account?: Account;
}
...
export abstract class BaseController<B = {}, P = {}> {
    ...
    protected abstract executeImpl(req: VideoAppRequest<B, P>, res: VideoAppResponse): Promise<void>;

    public async execute(req: express.Request, _res: express.Response): Promise<void> {

        console.log('in base exeute method')
        const res = new VideoAppResponse(_res);
        ...
        console.log(bodySchemaValidationRes.error);
        ...
        const nettuReq: VideoAppRequest<B, P> = {
