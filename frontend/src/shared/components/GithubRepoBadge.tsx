...
const useStyles = makeStyles((theme) => ({
  ...
  right: {
    ...
    fontSize: "12px",
    "&:hover": {
      color: "#1976d2", // replace with the desired color
    },
  },
}));

export const GithubRepoBadge = () => {
  ...
  useEffect(() => {
    const getStars = async () => {
      const res = await axios.get(
        "https://api.github.com/repos/kushal88053/VideoConfrence"
      );
  ...
  return (
    <a
      ...
      href="https://github.com/kushal88053/VideoConfrence"
      target="_blank"
